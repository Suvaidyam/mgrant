...
<div class="d-flex align-items-center justify-content-between" ">
    <div class="d-flex" style="gap: 10px;">
        ...
        $('#task-list').empty().html(
            `<div class="table-responsive">
                <table style="margin: 10px 0px !important;" class="table table-bordered">
                <thead style="background:#F3F3F3;" class="" >
                        <tr >
                            <th style="text-align: center;" class=" font-weight-bold align-middle" style="font-weight: 500; font-size: 12px;  color: rgb(82, 82, 82);" ><input type="checkbox" id="selectAllCheckBox" style="width: 16px !important; height: 16px !important;"></th>
                        ...
                        ${task_list.map(task => {
                            return `
                                <tr style="height: 32px !important;">
                                    <td style="padding: 0.5rem; text-align: center; vertical-align: middle;"><input type="checkbox" class="toggleCheckbox" data-id="${task.name}" style="width: 16px !important; height: 16px !important; text-align: center !important;" ></td>
...
const getTaskList = async (frm, selector) => {
    ...
    $(`[data-fieldname="${selector}"]`).empty().html(`
